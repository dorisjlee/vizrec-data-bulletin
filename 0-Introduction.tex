...
this space becomes even larger. \dor{say this is out of scope for this paper, e.g. Voyager ~\cite{Wongsuphasawat2017}}
...
\par
\stitle{State of the Art: Current Visual Query Systems.}
...
\dor{Should we say something about VQSs using perceptually-aware objectives?)}
...
efficient search for visual insights. \dor{Our discussion in this paper focuses on the interface and interactions, rather than optimizations (sampling, pruning, etc.) commonly used in VQSs[CITE]. }
...
of discovery goal \dor{of input query?}, and we will allude to the specific discovery
...
\dor{Clarify complexity as in system has to do more `guesswork'}
