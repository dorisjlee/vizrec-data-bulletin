...
\caption{\vida Architecture\agp{fix; convert figure into a wrapfigure}\label{fig:vida_architecture}
}
\end{figure}
...
Thus \zv is a natural starting point for \vida. 

\par However, our \zv design study demonstrates
that the precise setting is insufficient for
addressing all of the demands of real-world use-cases.
In particular, we find that users do not have
