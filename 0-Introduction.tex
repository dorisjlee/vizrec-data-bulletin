...
\end{tabular}
\caption{Overview of the systems described in this paper. Columns are organized into discovery goals and rows are ordered by decreasing levels of query specificity and correspondingly increasing levels of autonomous assistance. \agp{fix}}\label{fig:table}
\end{table}

\par
\stitle{\vida Interfaces.} To support the spectrum of 
demands imposed by the
discovery settings described above, \vida 
must support a range of interactive input mechanisms,
as displayed in Figure~\agp{}. 
\vida must support both a spectrum of intuitive interactions,
such as point-and-click, drag-and-drop, sketching, and brushing and linking,
along with natural-language-based interactions. 
